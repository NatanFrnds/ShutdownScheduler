...
public class ShutdownScheduler extends JFrame {
    private final JRadioButton byDateTimeRadio = new JRadioButton("Por Horario (data/hora);");
    ...
    private JButton shutdownNowBtn = new JButton("Desligar agora");
    private final JLabel statusLabel = new JLabel("Status pronto!");

    private final Timer uiTimer;
    private Long scheduleEpochMills = null;
    ...
    if (!isWindows()){
        JOptionPane.showMessageDialog(this,
                "Este utilitario suporta somente windows no momento",
    ...
    minuteSpinner = new JSpinner(minutesModel);
